                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {location.nextEvents.map((event, eventIndex) => {
                      ...
                      <Wrapper
                        key={eventIndex}
                        className={`flex flex-col gap-2 rounded-md px-2 py-2 transition-colors w-full text-left ${clickable ? 'hover:bg-muted/50' : ''}`}
                        {...wrapperProps}
                      >
                        {/* Row 1: title + actions */}
                        ...
                        {/* Row 2: details spanning full width */}
                        <div className="text-xs text-muted-foreground flex items-center gap-2 flex-wrap pl-4">
